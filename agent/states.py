# Actually this is supposed to be called schemas.py but the community has this way of organizing code
...
class plan(BaseModel): 
    ...
    features: list[str] = Field(description="A list of features that the app would have, e.g. 'user authentication', 'data visualization', etc")
...
class TaskPlan(BaseModel): 
    implementation_steps: list[ImplementationTask] = Field(description="A list of steps to be taken to implement a task.")
